...
const StyledDiv = styled.div`
  ...
  background: linear-gradient(204.24deg, #4f56c3 -0.04%, #3a45a7 84.48%);
  padding: 48px;
  flex-grow: 0;
  position: relative;
...
const Login: React.FC<{}> = () => {
  ...
  const props = (window as any).__APP_STATE__ as {
  ...
  const handleRegisterSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/pendingAccounts/",
        {
          method: "POST",
          headers: {
  ...
  const toggleTerms = () => {
    ...
    if (registerBtn) {
      ...
      newTermsChecked
        ? (registerBtn.style.background = "#6e46ae")
        : (registerBtn.style.background = "#cccccc");
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <StyledDiv
            style={{
              ...
              background:
                "linear-gradient(204.24deg, blue -0.04%, violet 84.48%)",
              padding: "48px",
              flexGrow: 0,
              position: "relative",
            }}
          >
            ...
            >
              Unlock Your Potential, Find Your Future!
            </p>
            <Text fontWeight="lighter" mt="default">
              ...
              >
                <li
                  style={{
                    listStyleImage:
                      "url(https://cloud.adminjs.co/images/list-bullet.svg)",
                    fontSize: "17px",
                    textShadow: "rgba(0, 0, 0, 0.3) 1px 1px 3px",
                  }}
                >
                  Sign in to unlock exclusive job opportunities tailored for
                  you.
                </li>
                <li
                  style={{
                ...
                >
                  Connect with a diverse range of employers and expand your
                ...
                >
                  Access personalized tools and resources to streamline your job
                  hunting process.
                </li>
              </ul>
            </Text>
          ...
          >
            ...
            <FormGroup>
              <CustomLabel style={{ color: "rgb(137, 138, 154)" }}>
            ...
            >
              ...
              <Button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "#6986b3";
                  e.currentTarget.style.borderColor = "transparent";
                  e.currentTarget.style.color = "white";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = "transparent";
                  e.currentTarget.style.borderColor = "#6986b3";
                  e.currentTarget.style.color = "#6986b3";
                }}
              >
                Create Account
              </Button>
          ...
          >
            <div
              style={{
                ...
                justifyContent: "space-between",
                marginBottom:
                  !registerMessage && !registerSuccessMessage ? "50px" : "0",
                marginTop: "15px",
                alignItems: "center",
              }}
            >
            ...
            {registerMessage && (
              <MessageBox
                my="lg"
                message={
                  registerMessage.split(" ").length > 1
                    ? registerMessage
                    : translateMessage(registerMessage)
                }
                variant="danger"
              />
            )}
            {registerSuccessMessage && (
              <MessageBox
                my="lg"
                message={
                  registerSuccessMessage.split(" ").length > 1
                    ? registerSuccessMessage
                    : translateMessage(registerSuccessMessage)
                }
                variant="success"
              />
            )}
          ...
          >
            <div
              style={{
                ...
                justifyContent: "space-between",
                marginBottom:
                  !forgotPasswordMessage && !forgotPasswordSuccessMessage
                    ? "50px"
                    : "0",
                marginTop: "15px",
                alignItems: "center",
            ...
            {forgotPasswordMessage && (
              <MessageBox
                my="lg"
                message={
                  forgotPasswordMessage.split(" ").length > 1
                    ? forgotPasswordMessage
                    : translateMessage(forgotPasswordMessage)
                }
                variant="danger"
              />
            )}
            {forgotPasswordSuccessMessage && (
              <MessageBox
                my="lg"
                message={
                  forgotPasswordSuccessMessage.split(" ").length > 1
                    ? forgotPasswordSuccessMessage
                    : translateMessage(forgotPasswordSuccessMessage)
                }
                variant="success"
              />
            )}
        ...
        >
          © Indeed Clone 2025. All rights reserved |{" "}

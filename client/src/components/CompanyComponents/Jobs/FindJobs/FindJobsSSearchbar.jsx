        ...
        >
          <div className="flex">
            ...
            <div className="relative w-full">
              ...
              <button
                type="submit"
                className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-jobportal-pink rounded-e-lg border border-jobportal-pink hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-jobportal-pink"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
          ...
          <button
            ...
            } transition-all active:bg-blue-700 hover:opacity-70 w-full absolute bottom-0 left-0 h-3`}
            type="button"
          >

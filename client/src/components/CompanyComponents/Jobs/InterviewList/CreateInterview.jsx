...
const CreateInterview = ({ userData }) => {
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/interviewlists/fromselectedapplicants/${id}`, {
        method: 'POST',
        headers: {
              ...
              <div className='max-w-[1200px] mx-auto items-center pt-5'>
                <div className='flex flex-col gap-5'>
                  ...
                  <form className='space-y-4 p-8 rounded-xl bg-white'>
                    ...
                    <input type='date' name='interviewDate' value={interviewDate} onChange={handleDateChange} className='w-full p-3 px-5 rounded' />

                    <label className='float-left' htmlFor='interviewDateTime'>
                      Set Scheduled Time
                    </label>
                    <input type='time' name='interviewTime' value={interviewTime} onChange={handleTimeChange} className='w-full p-3 px-5 rounded' />
                  ...
                  <div className='flex justify-between pb-5'>
                    <Link
                      ...
                      className='flex items-center gap-3 rounded-md bg-jobportal-pink px-5 py-4 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600'
                    >
                      {/* Left Arrow SVG */}

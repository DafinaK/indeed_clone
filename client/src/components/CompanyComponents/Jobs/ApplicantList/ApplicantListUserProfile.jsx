            ...
            {resume.s3Key ? (
              <>
                {resume.mime == 'application/pdf' ? (
                  <>
                    <button onClick={handleOpenPreview} className='py-2 px-2 text-white bg-jobportal-pink rounded hover:bg-blue-700'>
                      Preview Resume
                    </button>
                    <div
                  ...
                  <a href={`http://localhost:5000/resumes/${resume.s3Key}`} className='text-center py-2 px-2 text-white bg-blue-600 rounded hover:bg-blue-700'>
                    Download Resume
                  </a>
                )}
              </>

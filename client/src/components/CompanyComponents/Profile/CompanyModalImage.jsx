...
export default function CompanyModalImage({ companyData, file, previewUrl, lastModifiedDate, handleImageChange }) {
  return (
    <>
      <div className='flex flex-col gap-4'>
        <h3 className='font-semibold text-lg'>Edit Company Logo:</h3>
        <hr />
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: '25px' }}>
          <div style={{ display: 'flex', width: '100%', alignItems: 'flex-end', justifyContent: 'space-evenly', gap: '25px' }}>
            <div style={{ textAlign: 'center', border: '1px solid #ccc', padding: '10px', borderRadius: '5px' }}>
              <img
                src={previewUrl || (companyData.CompanyLogo ? `http://localhost:5000/companyLogos/${companyData.CompanyLogo?.s3Key}` : grayLogo)}
                style={{
                  width: '125px',
                  height: '125px',
                  objectFit: 'cover',

              ...
              <div className='max-w-[1200px] m-auto'>
                <div className='flex px-4 py-8 gap-[12px] flex-wrap'>
                  <div className='flex flex-col w-full md:w-[400px] gap-4'>
                    ...
                    <div className='bg-blue-200 shadow-lg w-full p-5 rounded-lg flex flex-col justify-between gap-8'>
                      {isPremium ? (
                        <>
                          <div className='flex flex-col gap-3'>
                            <h1 className='text-lg font-bold text-blue-900'>You have a premium account!</h1>
                            <p className='text-blue-900'>You are now one of our premium members!</p>
                            <p className='text-blue-900'>Subscription type: {subscriptionData?.planName}</p>
                            {subscriptionData?.planDescription?.split(', ').map((benefit, index) => (
                              <div key={index} className='flex flex-row gap-2.5 items-start text-left text-sm text-blue-900 ml-3'>
                                <span>{benefit}</span>
                              </div>
                            ))}
                          </div>
                        ...
                        <>
                          {companyData.FreeJobPosted ? (
                            <>
                              <div className='flex flex-col gap-3'>
                                <h1 className='text-lg font-bold text-blue-900'>You have already posted your free job.</h1>
                              ...
                              <div className='flex flex-col gap-3 w-full'>
                                <Link to='/pricing' className='bg-jobportal-pink text-center text-white w-full px-3 py-2 rounded hover:bg-blue-700 active:bg-fuchsia-800'>
                                  View Subscriptions
                                </Link>
                              </div>
                            </>
                            ...
                            <>
                              <div className='flex flex-col gap-3'>
                                <h1 className='text-lg font-bold text-blue-900'>You still have your free job posting.</h1>
                                <p className='text-blue-900'>
                              ...
                              <div className='flex flex-col gap-3 w-full md:w-auto'>
                                <Link
                                  ...
                                  className='bg-jobportal-pink text-white w-full text-center md:w-auto px-3 py-2 rounded hover:bg-blue-700 active:bg-fuchsia-800'
                                >
                                  Create New Post
                                </Link>
                              </div>

  ...
  return (
    <div className='confirmAccount__step'>
      ...
      <div style={{ display: 'flex', gap: '40px' }}>
        ...
        >
          <img src={illustration} className='border border-blue-700' style={{ width: '200px', height: '275px', objectFit: 'cover', objectPosition: 'center center' }} />
        ...
        >
          <img src={pricing} className='border border-blue-700' style={{ width: '200px', height: '275px', objectFit: 'cover', objectPosition: 'center center' }} />

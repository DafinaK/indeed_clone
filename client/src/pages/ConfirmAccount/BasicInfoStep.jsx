            ...
            <div style={{ display: 'flex', marginTop: '43px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', width: '100%' }}>
                ...
                <select
                  ...
                  tabIndex='-1'
                  name='Month'
                  style={{ width: '90%', padding: '18px', outline: '1px solid blue', borderRadius: '4px', background: 'white' }}
                >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', width: '100%' }}>
                ...
                <input
                  ...
                  name='day'
                  placeholder='Day'
                  style={{ width: '90%', padding: '18px', outline: '1px solid blue', borderRadius: '4px' }}
                />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', width: '100%' }}>
            ...
            <div style={{ display: 'flex', width: '97%', gap: '20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '100%' }}>
                ...
                <select
                  ...
                  tabIndex='-1'
                  name='gender'
                  style={{ width: '100%', padding: '18px', outline: '1px solid blue', borderRadius: '4px', background: 'white' }}
                >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '100%' }}>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '18px', outline: '1px solid blue', borderRadius: '4px' }}
                />
              </div>
            </div>
          </div>

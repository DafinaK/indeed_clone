                ...
                <div id='slider' className='flex items-center gap-3'>
                  {totalPages.map((page) => (
                    <button
                      ...
                      className={`border ${
                        page === currentPage ? 'border-blue-700 bg-jobportal-pink text-white' : 'border-gray-300 bg-gray-100'
                      } p-3.5 rounded-lg hover:border-blue-700 hover:bg-jobportal-pink hover:text-white`}
                    >
                      {page}
                    </button>
                  ))}
                    ...
                    <div className='flex gap-3'>
                      {userData ? (
                        applied ? (
                          ...
                          <button className='bg-green-500 hover:bg-blue-700 text-white rounded-lg font-semibold flex items-center'>
                          ...
                          <>
                            <button onClick={handleApplyClick} className='bg-jobportal-pink hover:bg-blue-700 text-white rounded-lg font-semibold flex items-center'>
                              <div className='flex gap-2 pr-5 pl-5 pt-2 pb-2 items-center'>
                        ...
                        <button className='bg-jobportal-pink hover:bg-blue-700 text-white rounded-lg font-semibold flex items-center'>
                          <div className='flex gap-2 pr-5 pl-5 pt-2 pb-2 items-center'>
                            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' className='size-8'>
                              <path
                                fillRule='evenodd'

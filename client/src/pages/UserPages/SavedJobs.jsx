                              ...
                              <div className="flex items-center  gap-10 w-full pl-5 pr-5">
                                ...
                                <div className="text-left w-3/12">
                                  <h5 className="text-jobportal-primary font-bold">
                                    {SavedJob.JobPost.positionName}
                                  </h5>
                                  <p className="text-gray-600">
                                    {SavedJob.JobPost.jobLocation}
                                  </p>
                                  <p className="text-gray-600">
                                    Posted:{" "}
                                    {formatDate(SavedJob.JobPost.createdAt)}
                                  </p>
                                </div>

                                <p className="text-gray-600 w-1/12 ">
                                  {formatDate(SavedJob.JobPost.startAt)}
                                </p>
                                <p className="text-gray-600 w-1/12 ">
                                  {formatDate(SavedJob.JobPost.endAt)}
                                </p>
                                <p className="text-gray-600 w-2/12 ">
                                  {SavedJob.JobPost.salary_from +
                                    "$ - " +
                                    SavedJob.JobPost.salary_to +
                                    "$"}
                                </p>

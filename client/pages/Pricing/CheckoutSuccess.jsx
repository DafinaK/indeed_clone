...
function CheckoutSuccess() {
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center"
      ...
      <div className="bg-white p-12 rounded-2xl shadow-2xl max-w-lg w-full">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-700 text-lg mb-4 text-center">
            ...
            <strong className="text-blue-600">indeedclonesite@gmail.com</strong>.
          </p>
          <Link
            to="http://localhost:3000/company/dashboard"
            className="mt-4 px-6 py-3 bg-blue-700 text-white text-lg font-semibold rounded-md hover:bg-blue-800 transition duration-300"
          >
            Go To Dashboard
          </Link>
        </div>
